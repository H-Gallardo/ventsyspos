...
<section class="content-header">
    <h1><?php echo e(app('translator')->getFromJson('invoice.edit_invoice_layout')); ?></h1>
</section>
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <span class="help-block"><?php echo e(app('translator')->getFromJson('lang_v1.invoice_logo_help', ['max_size' => '1 MB'])); ?><br> <?php echo e(app('translator')->getFromJson('lang_v1.invoice_logo_help2')); ?></span>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_logo', 1, $invoice_layout->show_logo, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_logo')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-12">
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_client_id', 1, $invoice_layout->show_client_id, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('lang_v1.show_client_id')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_customer', 1, $invoice_layout->show_customer, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_customer')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_business_name', 1, $invoice_layout->show_business_name, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_business_name')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_location_name', 1, $invoice_layout->show_location_name, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_location_name')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_time', 1, $invoice_layout->show_time, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('lang_v1.show_time_with_date')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_sales_person', 1, $invoice_layout->show_sales_person, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('lang_v1.show_sales_person')); ?></label>
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_landmark', 1, $invoice_layout->show_landmark, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('business.landmark')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_city', 1, $invoice_layout->show_city, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('business.city')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_state', 1, $invoice_layout->show_state, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('business.state')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_country', 1, $invoice_layout->show_country, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('business.country')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_zip_code', 1, $invoice_layout->show_zip_code, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('business.zip_code')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">
            <label><?php echo e(app('translator')->getFromJson('invoice.fields_to_shown_for_communication')); ?>:</label>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_mobile_number', 1, $invoice_layout->show_mobile_number, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_mobile_number')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_alternate_number', 1, $invoice_layout->show_alternate_number, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_alternate_number')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_email', 1, $invoice_layout->show_email, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_email')); ?></label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="form-group">
            <label><?php echo e(app('translator')->getFromJson('invoice.fields_to_shown_for_tax')); ?>:</label>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_tax_1', 1, $invoice_layout->show_tax_1, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_tax_1')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_tax_2', 1, $invoice_layout->show_tax_2, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_tax_2')); ?></label>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_brand', 1, $invoice_layout->show_brand, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('lang_v1.show_brand')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_sku', 1, $invoice_layout->show_sku, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('lang_v1.show_sku')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_cat_code', 1, $invoice_layout->show_cat_code, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('lang_v1.show_cat_code')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
              <?php echo Form::checkbox('show_sale_description', 1, $invoice_layout->show_sale_description, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('lang_v1.show_sale_description')); ?></label>
            </div>
        ...
        <?php if(request()->session()->get('business.enable_product_expiry') == 1): ?>
          <div class="col-sm-3">
            <div class="form-group">
              <div class="checkbox">
                <label>
                  <?php echo Form::checkbox('show_expiry', 1, $invoice_layout->show_expiry, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('lang_v1.show_product_expiry')); ?></label>
                </div>
            </div>
          </div>
        <?php endif; ?>
        <?php if(request()->session()->get('business.enable_lot_number') == 1): ?>
          <div class="col-sm-3">
            <div class="form-group">
              <div class="checkbox">
                <label>
                  <?php echo Form::checkbox('show_lot', 1, $invoice_layout->show_lot, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('lang_v1.show_lot_number')); ?></label>
                </div>
            </div>
          </div>
        <?php endif; ?>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_payments', 1, $invoice_layout->show_payments, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_payments')); ?></label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_barcode', 1, $invoice_layout->show_barcode, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('invoice.show_barcode')); ?></label>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('is_default', 1, $invoice_layout->is_default, ['class' => 'input-icheck']);; ?> <?php echo e(app('translator')->getFromJson('barcode.set_as_default')); ?></label>
            </div>
          </div>
        </div>
        <?php endif; ?>
