	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><?php echo e(app('translator')->getFromJson('sale.shipping')); ?></h4>
			</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="posShippingModalUpdate"><?php echo e(app('translator')->getFromJson('messages.update')); ?></button>
