...
<section class="content">
  <div class="box">
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-md-3">
          <h4><?php echo e(app('translator')->getFromJson( 'role.access_locations' )); ?></h4>
        </div>
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('location_permissions[]', 'location.' . $location->id, in_array('location.' . $location->id, $role_permissions), 
