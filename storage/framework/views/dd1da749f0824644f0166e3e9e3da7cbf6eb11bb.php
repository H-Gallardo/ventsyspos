...
<script type="text/javascript">
	$(document).ready( function() {
		...
		<?php if(!empty($shortcuts["pos"]["express_checkout"]) && ($pos_settings['disable_express_checkout'] == 0)): ?>
			Mousetrap.bind('<?php echo e($shortcuts["pos"]["express_checkout"]); ?>', function(e) {
				e.preventDefault();
		...
		<?php if(!empty($shortcuts["pos"]["cancel"])): ?>
			Mousetrap.bind('<?php echo e($shortcuts["pos"]["cancel"]); ?>', function(e) {
				e.preventDefault();
		...
		<?php if(!empty($shortcuts["pos"]["draft"]) && ($pos_settings['disable_draft'] == 0)): ?>
			Mousetrap.bind('<?php echo e($shortcuts["pos"]["draft"]); ?>', function(e) {
				e.preventDefault();
		...
		<?php if(!empty($shortcuts["pos"]["pay_n_ckeckout"]) && ($pos_settings['disable_pay_checkout'] == 0)): ?>
			Mousetrap.bind('<?php echo e($shortcuts["pos"]["pay_n_ckeckout"]); ?>', function(e) {
				e.preventDefault();
		...
		<?php if(!empty($shortcuts["pos"]["edit_discount"]) && ($pos_settings['disable_discount'] == 0)): ?>
			Mousetrap.bind('<?php echo e($shortcuts["pos"]["edit_discount"]); ?>', function(e) {
				e.preventDefault();
		...
		<?php if(!empty($shortcuts["pos"]["edit_order_tax"]) && ($pos_settings['disable_order_tax'] == 0)): ?>
			Mousetrap.bind('<?php echo e($shortcuts["pos"]["edit_order_tax"]); ?>', function(e) {
				e.preventDefault();
		...
		<?php if(!empty($shortcuts["pos"]["add_payment_row"]) && ($pos_settings['disable_pay_checkout'] == 0)): ?>
			...
			Mousetrap.bind('<?php echo e($shortcuts["pos"]["add_payment_row"]); ?>', function(e, combo) {
		...
		<?php if(!empty($shortcuts["pos"]["finalize_payment"]) && ($pos_settings['disable_pay_checkout'] == 0)): ?>
			var payment_modal = document.querySelector('#modal_payment');
			Mousetrap(payment_modal).bind('<?php echo e($shortcuts["pos"]["finalize_payment"]); ?>', function(e, combo) {
				if($('#modal_payment').is(':visible')){
					e.preventDefault();
		...
		<?php if(!empty($shortcuts["pos"]["recent_product_quantity"])): ?>
			...
			Mousetrap.bind('<?php echo e($shortcuts["pos"]["recent_product_quantity"]); ?>', function(e, combo) {
				...
				if(last_qty_field.length >=1){
					...
					Mousetrap.trigger('<?php echo e($shortcuts["pos"]["recent_product_quantity"]); ?>');
				}
			});
		...
		<?php if(!empty($shortcuts["pos"]["add_new_product"])): ?>
			Mousetrap.bind('<?php echo e($shortcuts["pos"]["add_new_product"]); ?>', function(e) {
				$('input#search_product').focus().select();
			});
		<?php endif; ?>
	});
