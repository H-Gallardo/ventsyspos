<div class="pos-tab-content">
    <h4><?php echo e(app('translator')->getFromJson('business.add_keyboard_shortcuts')); ?>:</h4>
    <p class="help-block"><?php echo e(app('translator')->getFromJson('lang_v1.shortcut_help')); ?>; <?php echo e(app('translator')->getFromJson('lang_v1.example')); ?>: <b>ctrl+shift+b</b>, <b>ctrl+h</b></p>
    <p class="help-block">
        <b><?php echo e(app('translator')->getFromJson('lang_v1.available_key_names_are')); ?>:</b>
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4><?php echo e(app('translator')->getFromJson('lang_v1.pos_settings')); ?>:</h4>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label>
                    ...
                    [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'lang_v1.subtotal_editable' )); ?>
            ...
            <div class="form-group">
                ...
                <br>
                  <label>
                    ...
                    [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'lang_v1.disable_suspend_sale' )); ?>
