<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo e(app('translator')->getFromJson( 'lang_v1.edit_customer_group' )); ?></h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <?php
                ...
                ?>
        <?php echo Form::number('amount', $customer_group->amount, ['class' => 'form-control','placeholder' => __( 'lang_v1.calculation_percentage'), 'max' => 100, 'min' => '-100', 'step' => 0.1]);; ?>
