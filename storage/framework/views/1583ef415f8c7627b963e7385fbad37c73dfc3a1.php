...
<div class="pos-tab-content">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
                ...
                [ 'class' => 'input-icheck', 'id' => 'purchase_in_diff_currency']);; ?> <?php echo e(__( 'purchase.allow_purchase_different_currency' )); ?>
        ...
        <div class="form-group">
            <div class="checkbox">
              <label>
                ...
                [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'lang_v1.enable_editing_product_from_purchase' )); ?>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
                <label>
                <?php echo Form::checkbox('enable_purchase_status', 1, $business->enable_purchase_status , [ 'class' => 'input-icheck', 'id' => 'enable_purchase_status']);; ?> <?php echo e(__( 'lang_v1.enable_purchase_status' )); ?>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
                <label>
                <?php echo Form::checkbox('enable_lot_number', 1, $business->enable_lot_number , [ 'class' => 'input-icheck', 'id' => 'enable_lot_number']);; ?> <?php echo e(__( 'lang_v1.enable_lot_number' )); ?>
