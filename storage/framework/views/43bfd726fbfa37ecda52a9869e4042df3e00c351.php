            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td>5</td>
                            <td><?php echo e(app('translator')->getFromJson('lang_v1.lot_number')); ?> <small class="text-muted">(<?php echo e(app('translator')->getFromJson('lang_v1.optional')); ?>)</small></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>6</td>
                            ...
                            <td><?php echo __('lang_v1.expiry_date_ins'); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
