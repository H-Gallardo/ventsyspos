...
<section class="content-header">
    <h1><?php echo e(app('translator')->getFromJson('barcode.add_barcode_setting')); ?></h1>
    <!-- <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('is_continuous', 1, false, ['id' => 'is_continuous']);; ?> <?php echo e(app('translator')->getFromJson('barcode.is_continuous')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('is_default', 1);; ?> <?php echo e(app('translator')->getFromJson('barcode.set_as_default')); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-12">
