...
<section class="content-header">
    <h1><?php echo e(app('translator')->getFromJson('product.variations')); ?>
        <small><?php echo e(app('translator')->getFromJson('lang_v1.manage_product_variations')); ?></small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
	...
	<div class="box">
        <div class="box-header">
        	<h3 class="box-title"><?php echo e(app('translator')->getFromJson('lang_v1.all_variations')); ?></h3>
        	<div class="box-tools">
                <button type="button" class="btn btn-block btn-primary btn-modal" 
                	data-href="<?php echo e(action('VariationTemplateController@create')); ?>" 
        	...
        	<table class="table table-bordered table-striped" id="variation_table">
        		<thead>
        			<tr>
        				...
        				<th><?php echo e(app('translator')->getFromJson('lang_v1.values')); ?></th>
