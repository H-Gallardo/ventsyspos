        ...
        <div class="col-sm-6">
          ...
          <div class="form-group hide" id="columnize-taxes">
            <div class="col-md-3">
              ...
              name="table_tax_headings[]" required="required" placeholder="tax 1 heading">
              <?php
            ...
            <div class="col-md-3">
              <input type="text" class="form-control" 
              name="table_tax_headings[]" placeholder="tax 2 heading">
            </div>
            <div class="col-md-3">
              <input type="text" class="form-control" 
              name="table_tax_headings[]" placeholder="tax 3 heading">
            </div>
            <div class="col-md-3">
              <input type="text" class="form-control" 
              name="table_tax_headings[]" placeholder="tax 4 heading">
            </div>
          </div>
