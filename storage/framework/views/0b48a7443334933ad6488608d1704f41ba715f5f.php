...
<section class="content-header">
    <h1><?php echo e(app('translator')->getFromJson( 'restaurant.bookings' )); ?></h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        ...
        <div class="col-sm-12">
            <select id="business_location_id" class="select2" style="width:50%">
                <option value=""><?php echo e(app('translator')->getFromJson('purchase.business_location')); ?></option>
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo e(app('translator')->getFromJson('restaurant.todays_bookings')); ?></h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table class="table table-bordered table-condensed" id="todays_bookings_table">
                        ...
                        <tr>
                            ...
                            <th><?php echo e(app('translator')->getFromJson('restaurant.booking_starts')); ?></th>
                            <th><?php echo e(app('translator')->getFromJson('restaurant.booking_ends')); ?></th>
                            <th><?php echo e(app('translator')->getFromJson('restaurant.table')); ?></th>
                            <th><?php echo e(app('translator')->getFromJson('messages.location')); ?></th>
                            <th><?php echo e(app('translator')->getFromJson('restaurant.service_staff')); ?></th>
                        </tr>
                        </thead>
                    </table>
                </div>
        ...
        <div class="col-sm-10">
            <div class="box">
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-primary pull-right" id="add_new_booking_btn"><i class="fa fa-plus"></i> <?php echo e(app('translator')->getFromJson('restaurant.add_booking')); ?></button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
            ...
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    <div class="external-event bg-light-blue text-center" style="position: relative;">
                        <small><?php echo e(app('translator')->getFromJson('restaurant.booked')); ?></small>
                    </div>
                    <div class="external-event bg-green text-center" style="position: relative;">
                        <small><?php echo e(app('translator')->getFromJson('restaurant.completed')); ?></small>
                    </div>
                    <div class="external-event bg-red text-center" style="position: relative;">
                        <small><?php echo e(app('translator')->getFromJson('restaurant.cancelled')); ?></small>
                    </div>
                    <small>
                    <p class="help-block">
                        <i><?php echo e(app('translator')->getFromJson('restaurant.click_on_any_booking_to_view_or_change_status')); ?><br><br>
                        <?php echo e(app('translator')->getFromJson('restaurant.double_click_on_any_day_to_add_new_booking')); ?>
                        </i>
                    </p>
                    </small>
                </div>
    ...
    <?php echo $__env->make('restaurant.booking.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php if(file_exists(public_path() . '/plugins/fullcalendar/locale/' . $fullcalendar_lang_file)): ?>
    <script src="<?php echo e(asset('plugins/fullcalendar/locale/' . $fullcalendar_lang_file . '?v=' . $asset_v)); ?>"></script>
<?php endif; ?>
