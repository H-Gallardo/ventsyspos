	...
	<div class="col-md-6 invoice-col width-50">
		...
		<?php if(!empty($receipt_details->all_due)): ?>
			<p class="bg-light-blue-active text-right font-23 padding-5">
				...
				<?php echo e($receipt_details->all_due); ?>
		...
		<table class="table table-bordered table-no-top-cell-border">
			<thead>
				<tr style="background-color: #357ca5 !important; color: white !important; font-size: 15px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					...
					<td style="background-color: #357ca5 !important; color: white !important;width: 10% !important;">
						<?php echo e($receipt_details->line_discount_label); ?>

					</td>
					<td style="background-color: #357ca5 !important; color: white !important;width: 10% !important;">
						<?php echo e($receipt_details->line_tax_label); ?>

					</td>
					<td style="background-color: #357ca5 !important; color: white !important;width: 10% !important;">
						<?php echo e($receipt_details->table_unit_price_label); ?> (<?php echo e(app('translator')->getFromJson('product.inc_of_tax')); ?>)
					</td>
					<td style="background-color: #357ca5 !important; color: white !important;width: 10% !important;">
				...
				<?php $__currentLoopData = $receipt_details->lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						...
						<td style="word-break: break-all;">
                            ...
                            <?php if(!empty($line['product_custom_fields'])): ?>, <?php echo e($line['product_custom_fields']); ?> <?php endif; ?>
						...
						<td class="text-right">
							<?php echo e($line['tax']); ?> <?php echo e($line['tax_name']); ?>

						</td>
						<td class="text-right">
							<?php echo e($line['unit_price_inc_tax']); ?>
						...
						<?php $__currentLoopData = $line['modifiers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modifier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								...
								<td>
		                            ...
		                            <?php if(!empty($modifier['sub_sku'])): ?>, <?php echo e($modifier['sub_sku']); ?> <?php endif; ?> 
								...
								<td class="text-right">
									<?php echo e($modifier['quantity']); ?> <?php echo e($modifier['units']); ?>
								...
								<td class="text-center">
									<?php echo e($modifier['unit_price_exc_tax']); ?>

								</td>
								<td class="text-right">
									<?php echo e($modifier['line_total']); ?>
