...
<section class="content-header">
    <h1><?php echo e(app('translator')->getFromJson( 'restaurant.modifier_sets' )); ?>
        <small><?php echo e(app('translator')->getFromJson( 'restaurant.manage_your_modifiers' )); ?></small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
	...
	<div class="box">
        <div class="box-header">
        	<h3 class="box-title"><?php echo e(app('translator')->getFromJson( 'restaurant.all_your_modifiers' )); ?></h3>
        ...
        <div class="box-body">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurant.view')): ?>
            	<table class="table table-bordered table-striped" id="modifier_table">
            		<thead>
            			<tr>
            				<th><?php echo e(app('translator')->getFromJson( 'restaurant.modifier_sets' )); ?></th>
                            <th><?php echo e(app('translator')->getFromJson( 'restaurant.modifiers' )); ?></th>
                            <th><?php echo e(app('translator')->getFromJson( 'restaurant.products' )); ?></th>
