...
<section class="content-header">
    <h1><?php echo e(app('translator')->getFromJson( 'account.trial_balance')); ?>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header print_section">
            <h3 class="box-title"><?php echo e(session()->get('business.name')); ?> - <?php echo e(app('translator')->getFromJson( 'account.trial_balance')); ?> - <span id="hidden_date"><?php echo e(\Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format'))); ?></span></h3>
        </div>
        <div class="box-body">
            <table class="table table-border-center-col no-border table-pl-12" id="trial_balance_table">
                <thead>
                    <tr class="bg-gray">
                        <th><?php echo e(app('translator')->getFromJson('account.trial_balance')); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <th><?php echo e(app('translator')->getFromJson('account.account_balances')); ?>:</th>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <th><?php echo e(app('translator')->getFromJson('account.capital_accounts')); ?>:</th>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                </tbody>
...
<script type="text/javascript">
    ...
    function update_trial_balance(){
        ...
        $.ajax({
            url: "<?php echo e(action('AccountReportsController@trialBalance')); ?>?end_date=" + end_date,
            dataType: "json",
