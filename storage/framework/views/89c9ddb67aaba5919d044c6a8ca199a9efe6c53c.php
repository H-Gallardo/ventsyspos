...
<section class="content">
	<h4>
		<?php echo e(app('translator')->getFromJson('essentials::lang.all_memos')); ?>
		<small> <?php echo e(app('translator')->getFromJson('essentials::lang.manage_memos')); ?></small>
	</h4>
		<div class="box">
			<div class="box-header">
				<h4 class="box-title"><?php echo e(app('translator')->getFromJson('essentials::lang.all_memos')); ?></h4>
			...
			<div class="box-body">
				...
				<div class="row">
					...
					<table class="table table-bordered table-striped documents">
						<thead>
							<tr>
								<th> <?php echo e(app('translator')->getFromJson('essentials::lang.heading')); ?></th>
								<th> <?php echo e(app('translator')->getFromJson('essentials::lang.description')); ?></th>
								<th> <?php echo e(app('translator')->getFromJson('essentials::lang.created_at')); ?></th>
