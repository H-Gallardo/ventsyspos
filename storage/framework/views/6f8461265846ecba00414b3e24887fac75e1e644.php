<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo e(app('translator')->getFromJson( 'restaurant.add_modifier' )); ?></h4>
    </div>
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-12">
          <h4><?php echo e(app('translator')->getFromJson( 'restaurant.modifiers' )); ?></h4>
        </div>
        ...
        <div class="col-sm-12">
          <table class="table table-condensed" id="add-modifier-table">
            <thead>
              <tr>
                <th><?php echo e(app('translator')->getFromJson( 'restaurant.modifier')); ?></th>
                <th>
                  <?php echo e(app('translator')->getFromJson( 'messages.price')); ?>
