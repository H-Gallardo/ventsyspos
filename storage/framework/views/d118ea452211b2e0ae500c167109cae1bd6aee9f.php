<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <?php echo Form::open(['url' => action('\Modules\Account\Http\Controllers\AccountController@postFundTransfer'), 'method' => 'post', 'id' => 'fund_transfer_form' ]); ?>


    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title"><?php echo e(app('translator')->getFromJson( 'account::lang.fund_transfer' )); ?></h4>
    </div>

    <div class="modal-body">
            <div class="form-group">
                <strong><?php echo e(app('translator')->getFromJson('account::lang.selected_account')); ?></strong>: 
                <?php echo e($from_account->name); ?>
            ...
            <div class="form-group">
                <?php echo Form::label('to_account', __( 'account::lang.transfer_to' ) .":*"); ?>
