<?php $__env->startSection('title', __( 'account::lang.balance_sheet' )); ?>

<?php $__env->startSection('content'); ?>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><?php echo e(app('translator')->getFromJson( 'account::lang.balance_sheet')); ?>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header print_section">
            <h3 class="box-title"><?php echo e(session()->get('business.name')); ?> - <?php echo e(app('translator')->getFromJson( 'account::lang.balance_sheet')); ?> - <span id="hidden_date"><?php echo e(\Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format'))); ?></span></h3>
        </div>
        <div class="box-body">
            <table class="table table-border-center no-border table-pl-12">
                <thead>
                    <tr class="bg-gray">
                        <th><?php echo e(app('translator')->getFromJson( 'account::lang.liability')); ?></th>
                        <th><?php echo e(app('translator')->getFromJson( 'account::lang.assets')); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <table class="table" id="assets_table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th colspan="2"><?php echo e(app('translator')->getFromJson('account::lang.account_balances')); ?>:</th>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr>
                                        <th colspan="2"><?php echo e(app('translator')->getFromJson('account::lang.capital_accounts')); ?>:</th>
                                    </tr>
                                </tbody>
                    ...
                    <tr class="bg-gray">
                        <td>
                            <table class="table bg-gray mb-0 no-border">
                                <tr>
                                    <th>
                                        <?php echo e(app('translator')->getFromJson('account::lang.total_liability')); ?>: 
                                    </th>
                                    <td>
                        ...
                        <td>
                            <table class="table bg-gray mb-0 no-border">
                                <tr>
                                    <th>
                                        <?php echo e(app('translator')->getFromJson('account::lang.total_assets')); ?>: 
                                    </th>
                                    <td>
...
<script type="text/javascript">
    ...
    function update_balance_sheet(){
        ...
        $.ajax({
            url: "<?php echo e(action('\Modules\Account\Http\Controllers\ReportsController@balanceSheet')); ?>?end_date=" + end_date,
            dataType: "json",
