...
<section class="content-header">
    <h1><?php echo e(app('translator')->getFromJson( 'account.balance_sheet')); ?>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header print_section">
            <h3 class="box-title"><?php echo e(session()->get('business.name')); ?> - <?php echo e(app('translator')->getFromJson( 'account.balance_sheet')); ?> - <span id="hidden_date"><?php echo e(\Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format'))); ?></span></h3>
        </div>
        <div class="box-body">
            <table class="table table-border-center no-border table-pl-12">
                <thead>
                    <tr class="bg-gray">
                        <th><?php echo e(app('translator')->getFromJson( 'account.liability')); ?></th>
                        <th><?php echo e(app('translator')->getFromJson( 'account.assets')); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <table class="table">
                                <tr>
                                    <th><?php echo e(app('translator')->getFromJson('account.supplier_due')); ?>:</th>
                                <td>
                        ...
                        <td>
                            <table class="table" id="assets_table">
                                <tbody>
                                    <tr>
                                        <th><?php echo e(app('translator')->getFromJson('account.customer_due')); ?>:</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th><?php echo e(app('translator')->getFromJson('report.closing_stock')); ?>:</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th colspan="2"><?php echo e(app('translator')->getFromJson('account.account_balances')); ?>:</th>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr>
                                        <th colspan="2"><?php echo e(app('translator')->getFromJson('account.capital_accounts')); ?>:</th>
                                    </tr>
                                </tbody>
                    ...
                    <tr class="bg-gray">
                        <td>
                            <table class="table bg-gray mb-0 no-border">
                                <tr>
                                    <th>
                                        <?php echo e(app('translator')->getFromJson('account.total_liability')); ?>: 
                                    </th>
                                    <td>
                        ...
                        <td>
                            <table class="table bg-gray mb-0 no-border">
                                <tr>
                                    <th>
                                        <?php echo e(app('translator')->getFromJson('account.total_assets')); ?>: 
                                    </th>
                                    <td>
...
<script type="text/javascript">
    ...
    function update_balance_sheet(){
        ...
        $.ajax({
            url: "<?php echo e(action('AccountReportsController@balanceSheet')); ?>?end_date=" + end_date,
            dataType: "json",
