<?php $__env->startSection('title', __('account::lang.payment_account_report')); ?>

<?php $__env->startSection('content'); ?>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><?php echo e(__('account::lang.payment_account_report')); ?></h1>
</section>
                ...
                <div class="box-body">
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo Form::label('account_id', __('account::lang.account') . ':'); ?>
                    ...
                    <table class="table table-bordered table-striped" id="payment_account_report">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(app('translator')->getFromJson('account::lang.payment_ref_no')); ?></th>
                                <th><?php echo e(app('translator')->getFromJson('account::lang.invoice_ref_no')); ?></th>
                                <th><?php echo e(app('translator')->getFromJson('lang_v1.payment_type')); ?></th>
                                <th><?php echo e(app('translator')->getFromJson('account::lang.account')); ?></th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            payment_account_report = $('#payment_account_report').DataTable({
                            ...
                            serverSide: true,
                            "ajax": {
                                "url": "<?php echo e(action('\Modules\Account\Http\Controllers\ReportsController@paymentAccountReport')); ?>",
                                "data": function ( d ) {
